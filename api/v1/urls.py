...
urlpatterns = [
    ...
    path('v1/guides/availability_for_location/',
         views.get_available_guides_for_location, name="get_available_guides_for_location"),
    ...
    path('v1/get_destinations_by_date/', views.get_destinations_by_date,
         name="get_destinations_by_date"),
    path('v1/create_destination/', views.create_destination,
